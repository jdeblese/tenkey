...
#define __LEDS_USER_H__
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			/** LED mask for the LED locations on the prototype board. */
		...
		/* Inline Functions: */
			...
			{
				LED_DDR  |= LEDS_ALL_LEDS;  /* LED I/Os as outputs */

				LED_PORT &= ~LEDS_ALL_LEDS;
			}
			...
			{
				LED_PORT = ((LED_PORT & ~LEDS_ALL_LEDS) | LEDMask);
			}
